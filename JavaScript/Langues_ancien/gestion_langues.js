...
function notationvitesseree2(){
	var texte = o_recupereJson();
	numberoftherockets = document.getElementById("nombre_de_fusees_input").value;
...
function texteUniversCalculs() {//Beaucoup des redondants, il faut gérer tout ça 
  ...
  document.getElementById("button_enregistrer").value = texte.page_univers_general.bouton_enregistrer;
  document.getElementById("JPC01_enregistrer").value = texte.page_univers_general.bouton_enregistrer;
  document.getElementById("JPC02_enregistrer").value = texte.page_univers_general.bouton_enregistrer;
  document.getElementById("JPC03_enregistrer").value = texte.page_univers_general.bouton_enregistrer;  
  document.getElementById("JPC04_enregistrer").value = texte.page_univers_general.bouton_enregistrer; 
  document.getElementById("JPC05_enregistrer").value = texte.page_univers_general.bouton_enregistrer; 
  document.getElementById("JPC06_enregistrer").value = texte.page_univers_general.bouton_enregistrer; 
  document.getElementById("JPC07_enregistrer").value = texte.page_univers_general.bouton_enregistrer; 
  document.getElementById("JPC08_enregistrer").value = texte.page_univers_general.bouton_enregistrer; 
  document.getElementById("JPC09_enregistrer").value = texte.page_univers_general.bouton_enregistrer; 
  document.getElementById("JPC10_enregistrer").value = texte.page_univers_general.bouton_enregistrer; 
  document.getElementById("JPC11_enregistrer").value = texte.page_univers_general.bouton_enregistrer; 
  //document.getElementById("JPC12_enregistrer").value = texte.page_univers_general.bouton_enregistrer; 
  ...
  document.getElementById("annee2").innerHTML = texte.page_univers_calculs.annee;
		...
		document.getElementById("boutonGraphe_z_t").value = texte.page_univers_calculs.bouton_tracer;
		...
		document.getElementById("txt_graphe_z_t").innerHTML = texte.page_univers_calculs.tracer_z_t;
  ...
  if (document.getElementById("txt_univplat")) {
    ...
    if (document.getElementById("EnergieSombre")) {
      ...
      document.getElementById("txt_photometrie").innerHTML = texte.page_univers_calculs.Photometrie;// il faut les placer on dehors de if else !! pas besoin de il else
