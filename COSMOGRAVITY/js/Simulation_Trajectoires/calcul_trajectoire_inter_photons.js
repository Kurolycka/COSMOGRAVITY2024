...
function trajectoire(compteur,mobile) {
   ...
   if (nbredefusees>=2) {
	...
	element2=document.getElementById('traject_type2');
		...
		dtau=rmax/c*1e-3;mobile["dtau"]=dtau;
	...
	if (document.getElementById('trace_present').value === "1") {
		...
		if (document.getElementById('trace_present').value === "1") {
			...
			if (sessionStorage.getItem("LANGUE") === "fr") {
				var nomFichier = prompt("Veuillez entrer le nom du fichier désiré :", "Trajectoire_EN_photon");
			}
			if (sessionStorage.getItem("LANGUE") === "en") {
				var nomFichier = prompt("Please enter the desired file name :", "Trajectory_DM_photon");
			}
