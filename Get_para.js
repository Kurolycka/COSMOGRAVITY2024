...
function transfert_simu(path) {
  ...
  messagebox("Attention",texte.page_univers_calculs.tracer_origine);
  if (path == 0) {
    if (calculs != 0) {
...
function transfert_simu_EN(path) {
  var texte = o_recupereJson();
  messagebox("Attention",texte.page_univers_calculs.tracer_origine);
  if (path == 0) {
    if (calculs != 0) {
      ...
      window.opener.document.getElementById("H0").value = Number(document.getElementById('Hz1').innerHTML);
      window.opener.document.getElementById("omegam0").value = Number(document.getElementById('Omz1').innerHTML);
      window.opener.document.getElementById("omegaDE0").value = Number(document.getElementById('Olz1').innerHTML);
      window.opener.document.getElementById("resultat_omegar0").innertHtml = Number(document.getElementById('Orz1').innerHTML);
      window.opener.document.getElementById("resultat_omegak0").innerHTML = Number(document.getElementById('Okz1').innerHTML);
      window.opener.document.getElementById("trace").click();
    } else {
  ...
  if (path == 1) {
    if (calculs != 0) {
      ...
      window.opener.document.getElementById("H0").value = Number(document.getElementById('Hz2').innerHTML);
      window.opener.document.getElementById("omegam0").value = Number(document.getElementById('Omz2').innerHTML);
      window.opener.document.getElementById("omegaDE0").value = Number(document.getElementById('Olz2').innerHTML);
      window.opener.document.getElementById("resultat_omegar0").innertHtml = Number(document.getElementById('Orz2').innerHTML);
      window.opener.document.getElementById("resultat_omegak0").innerHTML = Number(document.getElementById('Okz2').innerHTML);
      window.opener.document.getElementById("trace").click();
    } else {
...
function afficheSerie() {
  ...
  var omegam0Infobulle = texte.page_univers_general.omega_m0_infobulle;
  var omegar0Infobulle = texte.page_univers_general.omega_r0_infobulle;
  if (chaine =="&Omega;<sub>Λ0</sub> = "){chaine=texte.page_univers_general.omega_Λ0_infobulle;}
  else {chaine=texte.page_univers_noire.omega_DE_0_infobulle}
  var omegak0Infobulle = texte.page_univers_general.omega_k0_infobulle;
  var T0Infobulle = texte.page_univers_general.temperature_present;

  document.getElementById("affichage").innerHTML = 
    '<span title="' + omegam0Infobulle + '">&Omega;<sub>m0</sub> = ' + serieBDD[0] + '</span>' +
    ' ; ' +
    '<span title="' + omegar0Infobulle + '">&Omega;<sub>r0</sub> = ' + serieBDD[1] + '</span>' +
    '<br/>' +
    '<span title="' + chaine + '">&Omega;<sub>Λ0</sub> = ' + serieBDD[2] + '</span>' +
    ' ; ' +
    '<span title="' + omegak0Infobulle + '">&Omega;<sub>k0</sub> = ' + serieBDD[3] + '</span>' +
    '<br/>' +
    '<span title="' + T0Infobulle + '">T<sub>0</sub> = ' + document.getElementById("T0calc").value + ' K</span>';
}
