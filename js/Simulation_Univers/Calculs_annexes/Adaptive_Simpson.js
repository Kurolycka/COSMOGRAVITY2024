...
//formule utilisee pour le calcul de distance metrique// en fait c'est E(x)^-1/2 alors c'est pas dm 
...
function fonction_dm_EN(x, omegam0, omegaDE0, Or) { // c'est bizarre mais c'est F(x)^-1/2
  return Math.pow(F(x,omegam0, omegaDE0, Or), (-1/2));
}*/
...
//omegalambda0 est omegaDE0 dans le cas de EN ... :(
