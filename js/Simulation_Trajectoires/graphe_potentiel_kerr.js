function graphique_creation_pot() {
  //meme si on definit bien data1 et 2 apres ca va chercher data2[0] donc data2[0] est undefined. Donc on ne rentre pas dans le code si c'est le cas.
...
/* svg.selectAll("line.x")
  ...
  svg.append("g")
    ...
    .attr("class", "y axis")
    .call(yAxis);
  titre = texte.pages_trajectoire.titre_graphe;
